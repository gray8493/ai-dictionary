  ...
  <footer className="flex flex-col gap-8 px-5 py-16 mt-16 text-center border-t border-gray-200/80 dark:border-gray-700/50 @container">
    ...
    <div className="flex flex-wrap justify-center gap-6">
      ...
      <a href="#">
        <div className="text-slate-600 dark:text-gray-400 hover:text-primary">
          <svg aria-hidden="true" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            <path clip-rule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.024.06 1.378.06 3.808s-.012 2.784-.06 3.808c-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.024.048-1.378.06-3.808.06s-2.784-.013-3.808-.06c-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.048-1.024-.06-1.378-.06-3.808s.012-2.784.06-3.808c.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 016.345 2.525c.636-.247 1.363-.416 2.427-.465C9.793 2.013 10.148 2 12.315 2zm-1.163 1.943c-1.042.045-1.698.21-2.227.427A3.396 3.396 0 006.166 6.166c-.217.529-.382 1.185-.427 2.227-.045 1.02-.057 1.347-.057 3.611s.012 2.59.057 3.611c.045 1.042.21 1.698.427 2.227a3.396 3.396 0 001.772 1.772c.529.217 1.185.382 2.227.427 1.02.045 1.347.057 3.611.057s2.59-.012 3.611-.057c1.042-.045 1.698-.21 2.227-.427a3.396 3.396 0 001.772-1.772c.217-.529.382-1.185.427-2.227.045-1.02.057-1.347.057-3.611s-.012-2.59-.057-3.611c-.045-1.042-.21-1.698-.427-2.227a3.396 3.396 0 00-1.772-1.772c-.529-.217-1.185-.382-2.227-.427C14.946 3.955 14.62 3.943 12.315 3.943h-1.163zM12 8.438a3.563 3.563 0 100 7.125 3.563 3.563 0 000-7.125zM12 14a2 2 0 110-4 2 2 0 010 4zm6.406-7.188a.938.938 0 100-1.875.938.938 0 000 1.875z" fill-rule="evenodd"></path>
          </svg>
        </div>
      </a>
    </div>
